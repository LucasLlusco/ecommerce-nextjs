...
const Description = () => {
  ...
  const borderStyles = hasBorder ? styles.Description__button__border : ""; 
  
  return (
    <section className={styles.Description}>
      <button onClick={handleClick} className={`${styles.Description__button} ${borderStyles}`}>
      ...
      <div className={styles.Description__text}>
        ...
        <p>Future World: Your Gateway to Tomorrow&apos;s Tech! Dive into a 
          world of cutting-edge gadgets and gear. Stay ahead of the curve and 
          redefine your digital lifestyle with us</p>
      </div>
    </section>  
  )
}
